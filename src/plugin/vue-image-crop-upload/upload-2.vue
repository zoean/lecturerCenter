...
export default {
  ...
  methods: {
    ...
    checkFile(file) {
      ...
      console.log(that.imgBeforeFiletype)
      console.log(file.type)
      if(that.imgBeforeFiletype.length>0&&(that.imgBeforeFiletype.indexOf(file.type) == -1)){
         that.hasError = true;
         that.errorMsg = "图片上传格式错误"
         return false
      }
      // 超出大小
...
.vue-image-crop-upload
  ...
  border-radius: 2px;
  border: none;
  background-color: rgba(77, 157, 252, 0.3);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
...
.vue-image-crop-upload
  ...
  background-color: rgba(77, 157, 252, 0.15);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
  ...
  background-color: rgba(77, 157, 252, 0.5);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
...
.vue-image-crop-upload
  ...
  background-color: rgba(77, 157, 252, 0.45);
}
.vue-image-crop-upload
  .vicp-wrap
  .vicp-step2
  ...
  background-color: rgba(77, 157, 252, 0.25);
}
...
.vue-image-crop-upload
  ...
  border-radius: 3px;
  background-color: #4d9dfc;
  -webkit-box-shadow: 0 2px 6px 0 rgba(77, 157, 252, 0.3);
  box-shadow: 0 2px 6px 0 rgba(77, 157, 252, 0.3);
...
.vue-image-crop-upload
  ...
  -webkit-box-shadow: 0 1px 4px 0 rgba(77, 157, 252, 0.7);
  box-shadow: 0 1px 4px 0 rgba(77, 157, 252, 0.7);
  border-radius: 100%;
  background-color: #4d9dfc;
}
