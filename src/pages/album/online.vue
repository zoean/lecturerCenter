	...
	<div>
		...
		<div class="main-table-warp" style="width: 915px;">
            ...
            <div class="condition-video-online-warp">
                ...
                <div class="select-warp mar-left">
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {field: 'albumName', title: '所属专辑', width: 74, titleAlign: 'center',columnAlign:'center',isResize:true},
        ...
        methods:{
                ...
                if (params.type === 'discharge'){   //下架
                    ...
                    this.$store.commit('layer/updateTipData',{
                        ...
                        con:[{
                                ...
                                title:'视频名称：',
                                msg:'<a href="'+AIDEO_PLAY+'?vid='+item.aliyunVideoId+'" target="_blank" style="color:#cc0000;text-decoration: underline;">'+item.videoName+'</a>'
                            },{
                                title:'标题：',
                                msg:item.videoTitle
                            },{
            ...
            getDate(){
                api.dateSetFn(qs.stringify({
                    d1:this.$store.state.dateTime.start,
                    d2:this.$store.state.dateTime.end,
