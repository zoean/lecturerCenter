        ...
        methods:{
            ...
            downOrder(){
                ...
                if(this.tableData.length==0){
                    ...
                    window.location.href=this.$fun.getUrlVerify("http://user.ggcj.com/audio/interface/album/orderdownload.audio?")+html;
                }
