    ...
    export default{
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {field: 'updateTime', title: '下架时间',width: 140, titleAlign: 'center',columnAlign:'center',isResize:true},
        	...
        	customCompFunc(params){
                ...
                if(params.type === 'edit'){
                    let param = {
                        ...
                        status: params.rowData['status']//音频状态 3-未通过审核
                    }
        ...
        created(){
            this.$store.dispatch('tableOpa/updateOpaList',[
                ...
                {content:'查看详情',style:{'color':'#4d9dfc'},type:'detaile'},
