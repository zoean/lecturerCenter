    ...
    export default{
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {field: 'updateTime', title: '创建时间',width: 140, titleAlign: 'center',columnAlign:'center',isResize:true},
        ...
        created(){
            this.$store.dispatch('tableOpa/updateOpaList',[
                {content:'查看详情',style:{'color':'#4d9dfc'},type:'detaile',permissFlag:'album'}
            ])
             /**
             * 获取音频列表
             */
