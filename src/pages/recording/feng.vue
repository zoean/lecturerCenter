            ...
            customCompFunc(params){
                if (params.type === 'shipment'){ 
                    this.$router.push({path:'/releaseVideo',
                        query:{
                            vid:params.rowData['userName'],
                            roomId:params.rowData['startDatetime'],
                            aliyunVideoId:params.rowData['expireDatetime'],
                            videoName: params.rowData['days']
                        }})
                }else if(params.type === 'delete'){
                    this.tableData.shift();
                    api.deleteFn(qs.stringify({
